...
const icon = (path: string, properties?: iconFuncProps) => {
    ...
    const pathProperties: Record<string, unknown> = { className: '' }
    if (properties?.fill === true) pathProperties.className += ' fill-current'
    else pathProperties.fill = 'none'

    if (properties?.stroke === true) {
        pathProperties.strokeLinecap = 'round'
        pathProperties.strokeLinejoin = 'round'
        pathProperties.strokeWidth = '2'
        pathProperties.className += ' stroke-current'
    }
    return (
        <svg
            viewBox={properties?.viewBox ?? '0 0 24 24'}
            xmlns='http://www.w3.org/2000/svg'
            className={properties?.width ?? ''}
            shapeRendering='geometricPrecision'
        >
            <path d={path} {...pathProperties} />
        </svg>
    )
}
...
export const Apple = (properties: IconProps): JSX.Element => {
    return icon(
        ...
        { width: properties.width, fill: true }
    )
}

export const Facebook = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Github = (properties: IconProps): JSX.Element => {
    return icon(
...
export const GoogleMaps = (properties: IconProps): JSX.Element => {
    return icon(
...
export const LinkedIn = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Medium = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Patreon = (properties: IconProps): JSX.Element => {
    return icon(
...
export const RSS = (properties: IconProps): JSX.Element => {
    return icon(
...
export const SoundCloud = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Spotify = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Twitter = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Windows = (properties: IconProps): JSX.Element => {
    return icon(
...
export const YouTube = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Alert = (properties: IconProps): JSX.Element => {
...
export const AlertCircle = (properties: IconProps): JSX.Element => {
...
export const AlertTriangle = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Check = (properties: IconProps): JSX.Element => {
...
export const ChevronDown = (properties: IconProps): JSX.Element => {
...
export const ChevronLeft = (properties: IconProps): JSX.Element => {
...
export const ChevronRight = (properties: IconProps): JSX.Element => {
...
export const ChevronUp = (properties: IconProps): JSX.Element => {
...
export const CheckCircle = (properties: IconProps): JSX.Element => {
...
export const Code = (properties: IconProps): JSX.Element => {
...
export const Command = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Dollar = (properties: IconProps): JSX.Element => {
...
export const Download = (properties: IconProps): JSX.Element => {
...
export const DownloadCloud = (properties: IconProps): JSX.Element => {
...
export const Edit = (properties: IconProps): JSX.Element => {
...
export const Edit2 = (properties: IconProps): JSX.Element => {
...
export const Edit3 = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Eye = (properties: IconProps): JSX.Element => {
...
export const EyeOff = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Grid = (properties: IconProps): JSX.Element => {
...
export const Headphones = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Information = (properties: IconProps): JSX.Element => {
...
export const Lock = (properties: IconProps): JSX.Element => {
    return icon(
...
export const LogIn = (properties: IconProps): JSX.Element => {
...
export const LogOut = (properties: IconProps): JSX.Element => {
...
export const Mail = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Menu = (properties: IconProps): JSX.Element => {
...
export const Music = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Phone = (properties: FillableIconProps): JSX.Element => {
    return icon(
...
export const Plus = (properties: IconProps): JSX.Element => {
...
export const Search = (properties: IconProps): JSX.Element => {
...
export const Send = (properties: IconProps): JSX.Element => {
...
export const Smartphone = (properties: IconProps): JSX.Element => {
    return icon(
...
export const Star = (properties: FillableIconProps): JSX.Element => {
    return icon(
...
export const User = (properties: IconProps): JSX.Element => {
    return icon(
...
export const X = (properties: IconProps): JSX.Element => {
...
export const XCircle = (properties: IconProps): JSX.Element => {
